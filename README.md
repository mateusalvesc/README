...
° 💻 Gosto muito de <strong>tecnologia</strong>, com foco em <strong>.programação</strong> ° 💼 Aluno no Senac Lapa Tito, em São Paulo-SP, realizando o curso de Programador Web Java... ° 🚀 Estudando sobre <strong>HTML5, CSS3, Figma, Lógica de Programação e JavaScript.</strong> ° 🎓 Ensino Médio Completo.
<div>
<hr>
